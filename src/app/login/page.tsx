        ...
        <div className="w-full max-w-sm animate-fade-in-up">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-charcoal mb-2">
              {isSignUp ? "Get started with Tasu" : "Welcome back"}
            </h1>
          ...
          <button
            ...
            disabled={loading}
            className="w-full border border-cream-dark bg-white hover:bg-cream-dark/20 text-charcoal font-medium py-3 rounded-xl transition-all disabled:opacity-50 text-sm flex items-center justify-center gap-3 mb-4 hover:shadow-sm active:scale-[0.98]"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {message && (
              <p className="text-sm text-green-700 bg-green-50 px-3 py-2 rounded-lg animate-fade-in">
                {message}
              </p>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-charcoal hover:bg-charcoal/90 text-white font-medium py-3 rounded-xl transition-all disabled:opacity-50 text-sm active:scale-[0.98]"
            >
              {loading
                ? "..."
                : isSignUp
