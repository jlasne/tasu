...
const statusConfig = {
  planned: { label: "Planned", color: "bg-cream text-warm-gray border-cream-dark" },
...
function RoadmapCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-cream-dark p-5 flex items-start gap-4 group transition-all hover:border-terracotta/20">
      {/* Vote */}
      <button
        ...
        className={`flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl border transition-all shrink-0 ${
          voted
            ...
            : "bg-cream border-cream-dark text-warm-gray hover:border-terracotta/30 hover:text-terracotta"
        }`}
      >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 flex-wrap mb-1">
          ...
          {item.category && (
            <span className="text-[10px] font-medium px-2 py-0.5 rounded-full border bg-cream text-warm-gray border-cream-dark">
              {item.category}
            </span>
          )}
        </div>
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-cream">
      <div className="max-w-2xl mx-auto py-8 px-4 sm:px-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-charcoal mb-1">Roadmap</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="text-warm-gray text-sm">Roadmap coming soon.</p>
          </div>
        ) : (
